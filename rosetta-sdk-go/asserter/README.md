...
[![GoDoc](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=shield)](https://pkg.go.dev/oasis-rosetta-gateway/rosetta-sdk-go/asserter?tab=doc)
...
```shell
go get oasis-rosetta-gateway/rosetta-sdk-go/asserter
```
