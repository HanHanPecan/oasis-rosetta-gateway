...
[![GoDoc](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=shield)](https://pkg.go.dev/github.com/oasisprotocol/oasis-rosetta-gateway/rosetta-sdk-go/client?tab=doc)
...
```shell
go get github.com/oasisprotocol/oasis-rosetta-gateway/rosetta-sdk-go/client
```
